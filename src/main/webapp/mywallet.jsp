    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <h1 class="text-warning">My Wallet</h1>
            </a>
        ...
        <div class="header text-center">
          <%
                    	try{
                    		...
                    		String Wallet="0";
                    		ResultSet  i =st.executeQuery("SELECT * from user2 WHERE pno = " + "'" + phone + "'" );
      ...
      <div class="content">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Withdraw Money to bank</h4>
              </div>
              <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <h2 class="text-info">User Dashboard /
                                <small class="text-muted">My Wallet</small>
                            </h2>
                        </div>
                    </div>
                </div>
